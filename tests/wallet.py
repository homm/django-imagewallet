...
from imagewallet.wallet import ImageFormat, Wallet
...
class ImageFormatTest(TestCase):
    ...
    def test_prepare(self):
        ...
        # При преобразовании в P используем блее точную палитру.
        im = ImageFormat(mode='RGB', mode_palette=Image.ADAPTIVE,
